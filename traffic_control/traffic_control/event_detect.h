#ifndef _EVENT_DETECT_H
#define _EVENT_DETECT_H
...
public:
    Event_detect() {};
    Event_detect(int mintersection_Id);
    void handle_data(detector_target_info_t& detector_target_info, node_data_t& mnode_data, node_traffic_flow_info_t& mnode_index);
    void mapdata_to_mapindex(node_data_t& mnode_data, node_traffic_flow_info_t& mnode_index);

public:
    ~Event_detect();

public:
    int intersection_Id;                                                                               //交叉口编号
